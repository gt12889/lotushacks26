      ...
      <form onSubmit={handleSubmit} className="flex gap-3">
        ...
        {supportsVoice && (
          <button
            ...
            className={`px-4 py-2.5 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed ${
              isListening
        ...
        <button
          ...
          className="px-6 py-2.5 bg-cyan text-abyss font-bold rounded-lg hover:bg-cyan/80 disabled:bg-t3/30 disabled:text-t3 disabled:cursor-not-allowed transition-colors whitespace-nowrap"
        >
